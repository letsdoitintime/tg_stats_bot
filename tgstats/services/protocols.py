...
class ChatServiceProtocol(Protocol):
    ...
    async def update_reaction_capture(self, chat_id: int, capture_reactions: bool) -> Optional[GroupSettings]:
...
class UserServiceProtocol(Protocol):
    ...
    async def handle_user_leave(self, chat_id: int, user_id: int, leave_date: datetime) -> Optional[Membership]:
