...
from tgstats.plugins import CommandPlugin, PluginManager, StatisticsPlugin
...
class SimpleCommandPlugin(CommandPlugin):
    ...
    def metadata(self):
        return PluginMetadata(
            name="test_command", version="1.0.0", description="Test command plugin", author="Test"
        )
...
class SimpleStatisticsPlugin(StatisticsPlugin):
    ...
    def metadata(self):
        return PluginMetadata(
            name="test_stats", version="1.0.0", description="Test stats plugin", author="Test"
        )
