...
async def handle_new_chat_members(
    ...
    for new_user in update.message.new_chat_members:
        ...
        logger.info(
            "Member joined", chat_id=chat.id, user_id=new_user.id, username=new_user.username
        )
...
async def handle_left_chat_member(
    ...
    logger.info("Member left", chat_id=chat.id, user_id=left_user.id, username=left_user.username)
